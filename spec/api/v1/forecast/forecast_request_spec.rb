...
RSpec.describe 'Forecast Request' do
  ...
  it 'can return the forecast for a location (city, state)', :vcr do
    ...
    expect(@res[:data][:attributes][:current_weather][:datetime]).to eq("2021-10-07T13:54:15.000-05:00")
    expect(@res[:data][:attributes][:current_weather][:sunrise]).to eq("2021-10-07T08:02:10.000-05:00")
    expect(@res[:data][:attributes][:current_weather][:sunset]).to eq("2021-10-07T19:32:52.000-05:00")
    expect(@res[:data][:attributes][:current_weather][:temperature]).to eq(74.1)
    expect(@res[:data][:attributes][:current_weather][:feels_like]).to eq(72.39)
    expect(@res[:data][:attributes][:current_weather][:humidity]).to eq(25)
    expect(@res[:data][:attributes][:current_weather][:uvi]).to eq(5.61)
    expect(@res[:data][:attributes][:current_weather][:conditions]).to eq("overcast clouds")
    ...
    expect(@res[:data][:attributes][:daily_weather][0][:date]).to eq("2021-10-07T13:00:00.000-05:00")
    expect(@res[:data][:attributes][:daily_weather][0][:sunrise]).to eq("2021-10-07T08:02:10.000-05:00")
    expect(@res[:data][:attributes][:daily_weather][0][:sunset]).to eq("2021-10-07T19:32:52.000-05:00")
    expect(@res[:data][:attributes][:daily_weather][0][:max_temp]).to eq(76.8)
    expect(@res[:data][:attributes][:daily_weather][0][:min_temp]).to eq(59.65)
    expect(@res[:data][:attributes][:daily_weather][0][:conditions]).to eq("overcast clouds")
    expect(@res[:data][:attributes][:daily_weather][0][:icon]).to eq("04d")

    expect(@res[:data][:attributes]).to have_key(:hourly_weather)
    expect(@res[:data][:attributes][:hourly_weather].length).to eq(8)
    expect(@res[:data][:attributes][:hourly_weather][0][:time]).to eq("2021-10-07T13:00:00.000-05:00")
    expect(@res[:data][:attributes][:hourly_weather][0][:temperature]).to eq(73.72)
    expect(@res[:data][:attributes][:hourly_weather][0][:conditions]).to eq("overcast clouds")
