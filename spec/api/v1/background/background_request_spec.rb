...
RSpec.describe 'Background Request' do
  ...
  it 'can return a background image for a location (city, state)', :vcr do
    ...
    expect(@res[:data][:attributes][:image][:image_url]).to eq( "https://images.unsplash.com/photo-1619856699906-09e1f58c98b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNjI5OTB8MHwxfHNlYXJjaHwxfHxkZW52ZXIlMkMlMjBjb3xlbnwwfHx8fDE2MzM1ODAzODQ&ixlib=rb-1.2.1&q=80&w=1080")
